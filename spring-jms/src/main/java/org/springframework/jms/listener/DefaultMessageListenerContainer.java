 ...
 * created through Spring's {@link TaskExecutor TaskExecutor}
...
public class DefaultMessageListenerContainer extends AbstractPollingMessageListenerContainer {
	 ...
	 * <p>Default is a {@link SimpleAsyncTaskExecutor},
	 ...
	 * @see SchedulingTaskExecutor#prefersShortLivedTasks()
	 */
	 ...
	 * <p>The default implementation builds a {@link SimpleAsyncTaskExecutor}
	 * with the specified bean name (or the class name, if no bean name specified) as thread name prefix.
	 * @see SimpleAsyncTaskExecutor#SimpleAsyncTaskExecutor(String)
	 */
