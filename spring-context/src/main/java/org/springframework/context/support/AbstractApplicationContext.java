...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			/**
			 * step3: refresh中各个方法的主要作用
			 *
			 * prepareRefresh：设置容器状态，和property source等
			 * obtainFreshBeanFactory: 创建bean工厂
			 * prepareBeanFactory: bean工厂投入生产前的各种配置，如类加载器，后置处理器等
			 * postProcessBeanFactory: 默认空实现
			 * invokeBeanFactoryPostProcessors: 应用BeanFactoryPostProcessor
			 * registerBeanPostProcessors: 实例化和注册BeanPostProcessor
			 * initMessageSource: 初始化MessageSource，辅助i18n
			 * initApplicationEventMulticaster: 初始化上下文的事件广播器
			 * onRefresh: 空实现
			 * registerListeners: 注册监听器
			 * finishBeanFactoryInitialization: 初始化非延迟加载的单例bean
			 * finishRefresh: 完成刷新
			 */
