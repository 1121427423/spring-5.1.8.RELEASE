...
public abstract class AbstractXmlApplicationContext extends AbstractRefreshableConfigApplicationContext {
	...
	protected void loadBeanDefinitions(DefaultListableBeanFactory beanFactory) throws BeansException, IOException {
		 ...
		 */
		beanDefinitionReader.setEnvironment(this.getEnvironment()); //设置上下文环境
		beanDefinitionReader.setResourceLoader(this); //设置资源加载器
		beanDefinitionReader.setEntityResolver(new ResourceEntityResolver(this)); //设置资源实体解析器
		...
		/**
		 * loadBeanDefinitions: step2
		 * 通过 XmlBeanDefinitionReader 加载 BeanDefinition
		 */
		loadBeanDefinitions(beanDefinitionReader); //通过 XmlBeanDefinitionReader 加载 BeanDefinition
	}
	...
	protected void loadBeanDefinitions(XmlBeanDefinitionReader reader) throws BeansException, IOException {
		/**
		 * 作用：使用给定的 XmlBeanDefinitionReader 加载 BeanDefinition
		 */
